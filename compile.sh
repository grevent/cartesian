...
ocamlbuild -use-ocamlfind -Is src/tools,src/kernel,src/interfaces,src/coreLib,src/standardLib,src/kernel/expressions,src/kernel/functions,src/kernel/actions,src/kernel/objects,src/kernel/patterns,src/kernel/prototypes -tag thread -package unix -package threads -Is src src/cartesianCLI.native
